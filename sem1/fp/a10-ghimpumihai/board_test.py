...
class TestGame(unittest.TestCase):
    ...
    def test_computer_strategy_placement(self):
        ComputerStrategy(self.board, 3, 3)
        self.assertEqual(self.board.obstruction_board[3][3], 1)
        self.assertEqual(self.board.obstruction_board[3][3], 1)
        self.assertEqual(self.board.obstruction_board[3][3], 1)
    ...
    def test_place_player_obstruction(self):
        ...
        self.assertEqual(self.board.obstruction_board[4][4], -1)
